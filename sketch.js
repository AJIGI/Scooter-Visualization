...
function showMenuScreen() {
  ...
  drawMenuButton(btn1, "📸", "View Photos", "Browse our scooter pictures", mouseX > btn1.x && mouseX < btn1.x + btn1.w && mouseY > btn1.y && mouseY < btn1.y + btn1.h);

  drawMenuButton(btn2, "📊", "View Data", "Explore Tableau visualizations", mouseX > btn2.x && mouseX < btn2.x + btn2.w && mouseY > btn2.y && mouseY < btn2.y + btn2.h);
}
...
function mousePressed() {
  ...
  if (screen === "start") {
    ...
    for (var i = 0; i < images.length; i++) {
      ...
      if (mouseX > x && mouseX < x + 400 && mouseY > y && mouseY < y + 250) {
